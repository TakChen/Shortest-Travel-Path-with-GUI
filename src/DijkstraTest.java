...
public class DijkstraTest {
	...
	public static boolean testDijkstra(String inputFile, String resultsFile) {
		...
		USAGraph gr = dijkstra.getGraph();
		BufferedReader br = null;
		
		try {
			br = new BufferedReader(new FileReader(resultsFile));
			String s;
			if (gr == null || gr.numNodes() ==0 ) {
				System.out.println("The number of nodes in your graph is 0.");
				System.out.println("Could not run the test.");
				return false;
			}
	 ...
	 * @param USAGraph gr
	 */
	public static void printInfo(String originCity, String destCity, ArrayList<Integer> returnedPath, String[] expectedPath, USAGraph gr) {
